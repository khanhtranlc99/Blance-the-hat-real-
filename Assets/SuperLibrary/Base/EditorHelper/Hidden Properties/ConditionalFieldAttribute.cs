...
public class ConditionalFieldAttribute : PropertyAttribute
{
    ...
    private readonly object _ignoreValue;

    public ConditionalFieldAttribute(string propertyToCheck, object compareValue = null, object ignoreValue = null)
    {
    ...
    public bool CheckPropertyVisible(SerializedProperty property)
    {
        ...
        string ignoreStringValue = _ignoreValue != null ? _ignoreValue.ToString().ToUpper() : "NULL";
        ...
        bool objectIgnore = ignoreStringValue == conditionPropertyStringValue;


        bool visible = isBoolMatch || objectMatch || (!objectIgnore && _ignoreValue != null);
        return visible;
    }
